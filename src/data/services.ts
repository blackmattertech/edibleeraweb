...
export const services: Record<string, ServicePage> = {
  ...
  'strategy-consulting': {
    ...
    metaDescription:
      'Edible oil consulting firm India offering sector strategy, market entry, portfolio planning, and competitive positioning for oils and speciality fats businesses in South Asia.',
    ...
    sections: [
      ...
      {
        title: 'Speciality Fats Industry Consulting South Asia',
        content: [
  ...
  'investment-advisory': {
    ...
    metaDescription:
      'Edible oil refinery investment India advisory with valuation support, due diligence, and investor reports for oils and speciality fats assets across South Asia.',
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          'Buy-side teams receive commercial diligence on offtake contracts, input cost exposure, and capex requirements for speciality fats sector assets.',
      ...
      },
      {
        ...
        content: [
          'Sponsors use our advisory to prioritise investments in speciality fats, oleochemical integration, and high-growth regional brands.',
        ],
      },
    ],
    insightLinks: [
  ...
  'policy-analysis': {
    ...
    metaDescription:
      'Edible oil policy India government analysis covering import duty changes, NMEO oilseeds mission impact, FSSAI speciality fats regulations, and blending rules for industry stakeholders.',
    ...
    sections: [
      ...
      {
        title: 'FSSAI Speciality Fats Regulations and Compliance',
        content: [
          'Speciality fats and oils regulatory India FSSAI updates—including trans fat limits and labelling requirements—affect product formulation and vanaspati segment strategy.',
